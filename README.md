...
- 好友系统：右上角“好友”按钮中可发送/接受好友请求、聊天，并让宠物访问好友家的宠物
...
数据库字段仍沿用 `hunger`，但界面按“饱腹值”展示：左侧代表饥饿，右侧代表饱腹。喂食会增加饱腹值；玩耍、睡觉、打工、AI 事件和时间流逝会让饱腹、心情、体力、清洁缓慢降低。饱腹值过低时宠物会进入 hungry 状态。
